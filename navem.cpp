...
Camera::Camera(){
    ...
    CameraObj.setFrameRate(90);
    //CameraObj.setShutterSpeed(330000);
    //CameraObj.setExposureCompensation(0);
    CameraObj.setBrightness(50);
    CameraObj.setSharpness (0);
    CameraObj.setContrast (0);
    CameraObj.setSaturation (0);
...
void* chamadaCamera(void* arg){
	...
	*/
	...
	for(int j = 0; j < quantidadeFrames ; j++)
	{
		...
		camera.CameraObj.retrieve ( camera.data,raspicam::RASPICAM_FORMAT_RGB );
