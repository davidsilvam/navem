...
##plt.show()
#ax=axes[0],
fig, axes = plt.subplots(nrows=1, ncols=1, figsize=(10, 5), sharey=True, dpi=100)
##plt.figure(figsize=(10,7), dpi= 100)
# bins = 30
# sns.distplot(d , ax=axes[0], kde_kws={"color": "g", "lw": 1, "label": "Raw data"} ,hist_kws={"linewidth": 1.3, "alpha": 0.5, "color": "g", "edgecolor":"black"})
sns.distplot(d1 , kde_kws={"color": "b", "lw": 1, "label": "Norm 0-1"} ,hist_kws={"linewidth": 1.3, "alpha": 0.5, "color": "b", "edgecolor":"black"})
